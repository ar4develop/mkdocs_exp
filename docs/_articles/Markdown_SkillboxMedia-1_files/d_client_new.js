...
function ct_replace_2(){
    ct_repl('body *',/495.120.40.96/gi, "495 266-81-84" );
    ct_repl('body *',/\(495\) 120.40.96/gi, "(495) 266-81-84" );
    ct_repl_a('a[href*="1204096"],a[href*="120-40-96"]','href','tel:+74952668184');
}
ct_ready(ct_replace_2);


window.calltouch_phone = "74952668184";

            if (window['ct'] && typeof window['ct'] === 'function') {
            window['ct']('create_session', { sessionId: 719571655, siteId: 32332, modId: 'u4sgb8pe', setCookie: true, endSessionTime: 1694507698, domain: 'skillbox.ru', setCtCookie: '1100000000507025649', setLkCookie: null, denialTime: 15, phones: {"113381":{"subPoolName":"\u0412\u0435\u0441\u044c \u0442\u0440\u0430\u0444\u0438\u043a","phoneId":"357067","phoneNumber":"74952668184","phoneCode":"495","phoneBody":"2668184"}}, ecommerceGa4Enabled: false, ecommerceTimeout: 1000, calltouchDnsHost: '', dataGoEnabled: false, GA4: [] });
                        } else {
            var xmlHttp = new XMLHttpRequest();
            xmlHttp.open( "GET", 'https://mod.calltouch.ru/set_attrs_by_get.php?siteId=32332&sessionId=719571655&attrs={"clientError_NO_CT_CREATE_SESSION": 1}', true );
            xmlHttp.send( null );
            }
...
})(window, "ctw", {"siteId":32332,"sessionId":719571655,"pageUrl":"https:\/\/skillbox.ru\/media\/code\/yazyk-razmetki-markdown-shpargalka-po-sintaksisu-s-primerami\/"})
        var call_value = '719571655';
        var call_value_u4sgb8pe = call_value;
        if(window.onSessionCallValue) {
        onSessionCallValue('719571655', '');
        }
